                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><span id="spnItem1"></span></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><span id="spnItem4"></span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body border-top">
                    <div class="row">
                        ...
                        <div class="offset-xl-1 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 p-3">
                            <h2 class="font-weight-normal mb-2"><span class="earnings-month" id="spnGananciasSemana1">$48,325</span>                                                    </h2>
                        ...
                        <div class="offset-xl-1 col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 p-3">
                            <h2 class="font-weight-normal mb-2">
                                ...
                                <span class="earnings-month" id="spnGananciasSemana2">$59,567</span>
                            </h2>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <asp:Literal ID="ltlPedidoRecientes" runat="server"></asp:Literal>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <asp:Literal ID="ltlProducto5Top" runat="server"></asp:Literal>
                            </tbody>
                        </table>
                    </div>
                </div>
