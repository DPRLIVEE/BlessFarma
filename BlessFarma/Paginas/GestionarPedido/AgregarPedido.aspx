<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="AgregarPedido.aspx.cs" Inherits="BlessFarma.Paginas.GestionarPedido.AgregarPedido" %>
                ...
                <div class="collapse show" id="filtercollapseCard2">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 mb-3">
                                <div class="py-3"></div>
                                <asp:Button runat="server" ID="btnAgregarPedido" CssClass="btn btn-primary form-control" OnClick="btnRegistrar_Click" Text="Agregar Nuevo Pedido" />
                            </div>
